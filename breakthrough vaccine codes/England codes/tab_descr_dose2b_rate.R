## Table 3 Demographic and clinical characteristics associated with COVID-19 hospitalisation or deaths
## in multi-variable Poisson models among individuals who recevied second or booster doses. 
...
DT <- DT[SecondVaccinationBrand=="AstraZeneca" | SecondVaccinationBrand=="Pfizer-BioNTech"]
...
AT <- rbind(A0,A1)
View(AT)
#write.csv(AT,file = "results/FINAL/t_desc_dose2b_rate.csv")
