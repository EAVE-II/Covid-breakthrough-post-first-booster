...
source("/conf/EAVE/GPanalysis/progs/UA/booster_dose_failures/00_Read_GP_Vaccinations.R")
...
z <- filter(z, !duplicated(EAVE_LINKNO))
z1 <- df_cohort %>% dplyr::select(-(EAVE_ASTHMA:EAVE_HYPERTENSION), -EAVE_BP, -n_risk_gps, -eave_weight) %>% 
