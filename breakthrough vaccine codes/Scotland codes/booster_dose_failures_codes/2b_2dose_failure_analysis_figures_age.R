...
# 
# df_cohort_vacc1$age_gp <- NULL
# df_cohort_vacc1<-filter(df_cohort_vacc1,ageYear<=64)
# df_cohort_vacc1<-mutate(df_cohort_vacc1,age_gp =
#                           cut(ageYear, breaks = c(-Inf, 49,54,59,64),
#                               labels=c("18-49","50-54","55-59","60-64")))
...
# 
# df_cohort_vacc1$age_gp <- NULL
# df_cohort_vacc1<-filter(df_cohort_vacc1,ageYear<50)
# df_cohort_vacc1<-mutate(df_cohort_vacc1,age_gp =
#                           cut(ageYear, breaks = c(-Inf, 49),
#                               labels=c("18-49")))
...
# 
# df_cohort_vacc1$age_gp <- NULL
# df_cohort_vacc1<-filter(df_cohort_vacc1,ageYear<40)
# df_cohort_vacc1<-mutate(df_cohort_vacc1,age_gp =
#                           cut(ageYear, breaks = c(-Inf, 39),
#                               labels=c("18-39")))
...
chars<-c('age_gp','Sex','simd2020_sc_quintile','ur6_2016_name','n_risk_gps',
         'n_tests_gp','vacc_gap', 'bmi_gp','pos_before_start_u')
event_list<-rbind()
for (i in 1:9){
...
#write.csv(results_f,paste0(project_path,"/output/cohort_description_b.csv"))
#write.csv(results_f,paste0(project_path,"/output/cohort_description_MO_b.csv"))
#write.csv(results_f,paste0(project_path,"/output/cohort_description_PB_b.csv"))

write.csv(results_f,paste0(project_path,"/output/cohort_description_b_under_75.csv"))
write.csv(results_f,paste0(project_path,"/output/cohort_description_b_under_65.csv"))
write.csv(results_f,paste0(project_path,"/output/cohort_description_b_under_50.csv"))
write.csv(results_f,paste0(project_path,"/output/cohort_description_b_under_40.csv"))
write.csv(results_f,paste0(project_path,"/output/cohort_description_b_above_75.csv"))
##########
#############
...
df_cohort_vacc1 <- filter(df_cohort_vacc_both,vacc_type_3=="Mo")
...
df_cohort_vacc1 <- filter(df_cohort_vacc_both,vacc_type_3=="PB")
##########
